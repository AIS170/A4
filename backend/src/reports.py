...
def reportBox():
    ...
    if communication_reports:  # Check if communication_reports is not empty
    ...
    if not formatted_reports:
        return render_template('report.html', formatted_reports=None, reports_empty=True)
    else:
        return render_template('report.html', formatted_reports=formatted_reports, reports_empty=False)
